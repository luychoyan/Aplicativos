...
export const PLANETAS_DATA = [
    {
        ...
        gravidade: 3.7, // m/s²
        distanciaSol: '0.4 UA',
        distanciaTerra: '77 milhões km (min.)',
        ...
        imagem: <Image style={{height: 70, width: 70, resizeMode: "cover"}} source={require("../assets/images/mercurio_icon.png")}/>, // Placeholder
    ...
    },
    {
        ...
        gravidade: 8.87,
        distanciaSol: '0.7 UA',
        distanciaTerra: '40 milhões km (min.)',
        ...
        imagem: <Image style={{height: 100, width: 100, resizeMode: "cover"}} source={require("../assets/images/venus_icon.png")}/>,
    ...
    },
    {
        ...
        imagem: <Image style={{height: 90, width: 90, resizeMode: "cover"}} source={require("../assets/images/terra_icon.png")}/>,
    ...
    },
    {
        ...
        gravidade: 3.72,
        distanciaSol: '1.5 UA',
        distanciaTerra: '54.6 milhões km (min.)',
        ...
        imagem: <Image style={{height: 80, width: 80, resizeMode: "cover"}} source={require("../assets/images/marte_icon.png")}/>,
    ...
    },
    {
        ...
        gravidade: 24.79,
        distanciaSol: '5.2 UA',
        distanciaTerra: '588 milhões km (min.)',
        ...
        imagem: <Image style={{height: 100, width: 100, resizeMode: "cover"}} source={require("../assets/images/jupiter_icon.png")}/>,
    ...
    },
    {
        ...
        gravidade: 10.44,
        distanciaSol: '9.5 UA',
        distanciaTerra: '1.2 bilhões km (min.)',
        ...
        imagem: <Image style={{height: 100, width: 100, resizeMode: "cover"}} source={require("../assets/images/saturno_icon.png")}/>,
    ...
    },
    {
        ...
        distanciaTerra: '2.5 bilhões km (min.)',
        ...
        imagem: <Image style={{height: 100, width: 100, resizeMode: "cover"}} source={require("../assets/images/urano_icon.png")}/>,
    ...
    },
    {
        ...
        distanciaTerra: '4.3 bilhões km (min.)',
        ...
        imagem: <Image style={{height: 100, width: 100, resizeMode: "cover"}} source={require("../assets/images/neturno_icon.png")}/>,
