...
export const PLANETAS_DATA = [
    {
        ...
        imagem: 'https://picsum.photos/400/300?random=1', // Placeholder
    ...
    // Adicionando um objeto secundário para um toque extra:
    {
        ...
        descricao: 'O único satélite natural da Terra e o quinto maior do Sistema Solar. É responsável pelas marés e foi o único corpo celeste visitado por humanos além da Terra.',
        imagem: 'https://picsum.photos/400/300?random=9',
        curiosidade: 'A Lua está se afastando da Terra a uma taxa de 3.8 cm por ano.',
    },
];